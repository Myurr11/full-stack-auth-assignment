    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-light text-gray-900 mb-3 tracking-tight">Welcome back</h1>
          <p className="text-lg text-gray-500 font-light">Sign in to continue to your workspace</p>
        </div>
